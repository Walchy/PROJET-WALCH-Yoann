...
export class CompteFormComponent implements OnInit, OnDestroy {
    // public client: Client = {} as Client;
    public showPasswordConfirmationMessageInvalid = false;
    registerClientForm: FormGroup;
    registerClientFormSubscription: Subscription;
    client: Client;
    ...
    ngOnDestroy(): void {
        this.registerClientFormSubscription.unsubscribe();
    }
}
